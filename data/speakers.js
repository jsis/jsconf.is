...
const speakers = [
  {
    ...
    company: 'Facebook',
    sponsor: 'facebook',
    title: 'Beyond React 16',
    description: '<p>React 16 was released several months ago. Even though this update was largely API-compatible, the rewritten internal engine included new long-requested features and opened the door for exciting future possibilities.</p><p>In this talk, Dan will share the React team’s vision for what the future of React might look like, including some never before seen prototypes.</p><p>Whether or not you use React, Dan hopes that you will find something valuable in this talk, and that it sparks new conversations about building delightful user interfaces.</p>',
  ...
  {
    name: 'Halldór Eldjárn & Þórður Hans Baldursson',
  ...
  },
  {
    ...
    company: 'Mozilla',
    sponsor: 'mozilla',
    title: 'Today: Making a browser fast, the story of Firefox Quantum.',
    description: `<p>What is expected from a browser has changed over the years. From displaying a simple text pages with a few images in the 90s to a tool that displays 4K videos at 120 fps for Virtual Reality applications, browser had to evolve to keep up with the expectation.</p><p>Through the example of Firefox, this is the story of some of the needed changes that modern browsers underwent over the past few years. How they fought yank, freezes and kept up being perceived as fast.</p>`.trim(),
